...
namespace AoC2020
{
    ...
    public class Day4
    {
        private static readonly HashSet<string> Ecls = new HashSet<string>{ "amb", "blu", "brn", "gry", "grn", "hzl", "oth"};
        ...
        {
            // Iterate over lines
            var stringReader = new StringReader(Day4Input);
            string line;
            var valid = 0;
            ...
            while ((line = stringReader.ReadLine()) != null)
            {
                ...
                {
                    if (fields.Count == 8 || (fields.Count == 7 && !fields.Contains("cid")))
                        valid++;
                    fields.Clear();
                }
            ...
            TestContext.WriteLine(valid.ToString());
        }
        ...
        private static bool IsValid(Dictionary<string, string> passport)
        {
            ...
            {
                foreach (var field in passport.Keys)
                {
                    switch (field)
                    {
                        case "byr":
                        ...
                        case "eyr":
                            ...
                            break;
                        case "hgt":
                            var match = Regex.Match(passport["hgt"], @"(\d+)(in|cm)");
                            if (!match.Success)
                                return false;
        ...
        private const string Valid = @"pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
hcl:#623a2f
...
iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719";
        ...
        private const string Invalid = @"eyr:1972 cid:100
...
pid:3556412378 byr:2007";
        ...
        private const string Day4Input = @"ecl:grn
